...
output_excel_path = 'processed_data_four_classes_15_measurements.xlsx'
...
for input_file_path in input_files:
    ...
    with open(input_file_path, 'r') as file:
        for line in file:
            ...
            elif line in ['fr_collision', 'front_col', 'right_col', 'left_col',
                          'back_col', 'collision']:
                current_label = 'col_robot_transfer'
            elif line in ['collision_in_part', 'collision_in_tool', 'bottom_collision']:
                current_label = 'col_arm_motion'
            elif line in ['moved', 'lost', 'slightly_moved']:
                current_label = None
            else:
                    ...
                    try:
                        ...
                        if len(values) == 6:
                            ...
                            if len(current_row) == 6 * num_groups:  # Verificar si se han alcanzado las 15 mediciones
                                ...
                                current_row.append(1 if current_label == 'col_robot_transfer' else 0)
                                current_row.append(1 if current_label == 'col_arm_motion' else 0)
    ...
    dynamic_columns.extend(['No Error', 'obstruction', 'col_robot_transfer', 'col_arm_motion'])
